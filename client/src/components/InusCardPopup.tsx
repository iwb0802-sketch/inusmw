        ...
        >
          ...
          >
            ...
            <div>
              ...
              >
                ...
                {" "}
                모바일 청첩장 <span style={{ color: "#8adfce" }} className="font-semibold">무료 제작 지원</span>
              </p>
            </div>
          </div>
          ...
          <div className="p-4 bg-white flex flex-col gap-2">
            <a
              ...
              className="block w-full py-3 text-center text-white text-sm font-medium tracking-wider rounded-sm transition-colors duration-300 hover:opacity-90"
              style={{ background: "#5BB5A2", fontFamily: "'Noto Serif KR', serif" }}
            >
              모바일 청첩장 바로가기 →
            </a>

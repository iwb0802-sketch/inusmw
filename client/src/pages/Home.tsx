...
const trustPoints = [
  ...
  { value: "2,700+", label: "누적 후기", caption: "실제 예식을 마친 신랑신부님들이 남긴 후기로 검증된 진행입니다.", icon: MessageCircle },
];
      ...
      <main id="top">
        <section className="grain relative min-h-[100svh] overflow-hidden pt-24">
          <div className="absolute inset-0">
            ...
            <div className="absolute inset-0 bg-[linear-gradient(180deg,rgba(18,10,4,0.87)_0%,rgba(40,20,8,0.44)_40%,rgba(40,20,8,0.48)_60%,rgba(18,10,4,0.92)_100%)]" />
            <div className="absolute inset-0 bg-[rgba(55,25,8,0.18)] mix-blend-multiply" />
            <div className="absolute inset-0 bg-[radial-gradient(circle_at_50%_40%,rgba(217,184,108,0.10),transparent_50%),radial-gradient(circle_at_50%_20%,rgba(217,184,108,0.12),transparent_40%)]" />
          </div>
          ...
          <div className="container relative z-10 flex min-h-[calc(100svh-6rem)] flex-col items-center justify-center gap-8 px-5 py-16 text-center sm:gap-12 sm:py-20">
            <div className="animate-rise-in max-w-4xl">
              ...
              <p className="mx-auto mt-5 max-w-2xl text-[0.8rem] leading-7 text-[#e8dcc1]/84 min-[360px]:text-sm sm:text-lg sm:leading-9 md:text-xl">
                <span className="block sm:inline">이너스뮤직은 노래와 안무, 진행까지</span>{" "}
                <span className="block sm:inline">하나의 완성된 서사로 예식을 만듭니다.</span>
              </p>
        ...
        {/* ── Performed Venues ── */}
        <section className="py-10 overflow-hidden" style={{ backgroundColor: "#0a0a0a", borderTop: "1px solid rgba(217,184,108,0.12)", borderBottom: "1px solid rgba(217,184,108,0.12)" }}>
          <div className="text-center mb-6">
            <p className="text-xs tracking-[0.3em] uppercase mb-3" style={{ color: "#d9b86c" }}>Performed Venues</p>
            <div className="inline-flex items-center gap-3">
              <div className="w-8 h-px" style={{ background: "linear-gradient(to right, transparent, #d9b86c)" }} />
              <span style={{ fontFamily: "'Cormorant Garamond', serif", fontSize: "clamp(1.6rem,4vw,2.4rem)", fontWeight: 700, color: "#fff" }}>
                <span style={{ color: "#d9b86c" }}>224</span>
                <span style={{ color: "#9ed4c0", fontSize: "1.2rem" }}>+</span>
              </span>
              <div className="w-8 h-px" style={{ background: "linear-gradient(to left, transparent, #d9b86c)" }} />
            </div>
        ...
        <section id="composition" className="bg-[#0d0a07] py-16 md:py-22">
          <div className="container">
            ...
            <div className="mt-10 grid gap-5 lg:grid-cols-[1.05fr_0.95fr]">
              ...
              <div className="rounded-[2rem] border border-[#d9b86c]/20 bg-[#130f0b] p-4 md:p-5">
                <div className="flex flex-col gap-2 border-b border-[#d9b86c]/12 pb-4">
            ...
            <Accordion type="single" collapsible className="mt-5 rounded-[1.6rem] border border-[#d9b86c]/18 bg-[#130f0b] px-3">
                  ...
                  <Accordion type="single" collapsible className="mt-5 rounded-[1.5rem] border border-[#d9b86c]/18 bg-[#0d0a07] p-2">
                    <AccordionItem value="repertoire" className="border-b-0">
                      ...
                      <AccordionContent className="px-2 pb-4 md:px-3">
                        ...
                        <p className="mt-5 rounded-[1.25rem] border border-[#d9b86c]/16 bg-[#d9b86c]/8 px-4 py-4 text-sm leading-7 text-[#d7ccb4]/82 md:text-base">
        ...
        <section id="pricing" className="bg-[#0d0a07] py-20 md:py-28">
          <div className="container">
            ...
            <div className="mt-8 rounded-[1.8rem] border border-[#d9b86c]/20 bg-[#130f0b] p-6 text-center">
        ...
        <section className="relative overflow-hidden py-20 md:py-28">
          <div className="container grid gap-6 lg:grid-cols-2">
            ...
            <article className="rounded-[1.4rem] border border-[#d9b86c]/22 bg-[#0d0a07] p-5 sm:rounded-[2.2rem] sm:p-8">
              ...
              <Accordion type="single" collapsible className="mt-6 rounded-[1.65rem] border border-[#d9b86c]/18 bg-black/20 p-2">
                    ...
                    <div className="grid gap-3">
                      {benefitCards.map((benefit) => (
                        <div key={benefit.title} className="rounded-[1.35rem] border border-[#d9b86c]/16 bg-black/24 p-4">
                          ...
                          {benefit.actionUrl ? (
                            <a href={benefit.actionUrl} target="_blank" rel="noreferrer" className="mt-4 inline-flex rounded-full border border-[#d9b86c]/42 bg-[#d9b86c]/10 px-4 py-2 text-sm font-bold text-[#f8edd4] transition hover:border-[#d9b86c]/45 hover:text-white">
                              {benefit.actionLabel}
                            </a>
                          ) : null}
                        </div>

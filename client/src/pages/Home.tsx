        ...
        <section className="py-10 overflow-hidden" style={{ backgroundColor: "#0a0a0a", borderTop: "1px solid rgba(217,184,108,0.12)", borderBottom: "1px solid rgba(217,184,108,0.12)" }}>
          ...
          <div className="relative">
            ...
            <style>{`
              ...
              .mw-marquee-track { display: flex; width: max-content; animation: mw-marquee 120s linear infinite; }
              .mw-marquee-track2 { display: flex; width: max-content; animation: mw-marquee2 120s linear infinite; }
